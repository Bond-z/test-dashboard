...
# #     endpoint = 'http://127.0.0.1:8000/api/get-scc-aws/{}/result/'.format(cycle)
# #     response = requests.get(endpoint)
# #     cycle = response.json()
...
# #     endpoint = 'http://127.0.0.1:8000/api/get-scc-azure/{}/result/'.format(cycle)
# #     response = requests.get(endpoint)
# #     current_cycle = response.json()
# #     return current_cycle

# # def get_fcpaws_current_result(cycle):
# #     endpoint = 'http://127.0.0.1:8000/api/get-fcp-aws/{}/result/'.format(cycle)
# #     response = requests.get(endpoint)
# #     current_cycle = response.json()
# #     return current_cycle

# # def get_fcpaz_current_result(cycle):
# #     endpoint = 'http://127.0.0.1:8000/api/get-fcp-azure/{}/result/'.format(cycle)
# #     response = requests.get(endpoint)
# #     current_cycle = response.json()
# #     return current_cycle
...
#     endpoint = 'http://127.0.0.1:8000/api/testcases/'
#     response = requests.get(endpoint)
#     if response.status_code == 200:
...
#     endpoint = 'http://127.0.0.1:8000/api/get-release-testresult/'
#     response = requests.get(endpoint)
#     data = response.json()
#     print(data)
#     organized_data = {}
...
#     endpoint = 'http://127.0.0.1:8000/api/get-scc-aws-result/'
#     response = requests.get(endpoint)
#     if response.status_code == 200:
...
#     endpoint = 'http://127.0.0.1:8000/api/get-scc-azure-result/'
#     response = requests.get(endpoint)
#     if response.status_code == 200:
...
#     endpoint = 'http://127.0.0.1:8000/api/get-fcp-aws-result/'
#     response = requests.get(endpoint)
#     if response.status_code == 200:
...
#     endpoint = 'http://127.0.0.1:8000/api/get-fcp-azure-result/'
#     response = requests.get(endpoint)
#     if response.status_code == 200:
...
#     endpoint = "http://127.0.0.1:8000/api/add-testcase/"
...
#     endpoint = "http://127.0.0.1:8000/api/update-testcase/f'{id}'"
